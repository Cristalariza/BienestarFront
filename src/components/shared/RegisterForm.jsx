        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex gap-6 justify-center mb-6">
            <div className="flex items-center gap-2">
              ...
              />
              <label htmlFor="sexo-m" className="cursor-pointer text-sm">
                Hombre
              </label>
            </div>
            <div className="flex items-center gap-2">
              ...
              />
              <label htmlFor="sexo-f" className="cursor-pointer text-sm">
                Mujer
              </label>
            </div>
            <div className="flex items-center gap-2">
              ...
              />
              <label htmlFor="sexo-o" className="cursor-pointer text-sm">
                Otros
              </label>
            </div>
          </div>
          ...
          <div className="grid grid-cols-3 gap-4 mb-4">
            ...
            <div>
              ...
              <Dropdown
                id="rol"
                value={formData.rol}
                options={estamentos.map((e) => ({
                  label: e.nombre,
                  value: e.estamento_id,
                }))}
          ...
          <div className="grid grid-cols-3 gap-4 mb-4">
            ...
            <div>
              ...
              <InputText
                ...
                onChange={(e) =>
                  handleChange("orientacion_sexual", e.target.value)
                }
                className="w-full"
              />
            </div>
          ...
          <div className="grid grid-cols-3 gap-4 mb-6">
            ...
            <div>
              ...
              <Dropdown
                ...
                options={programasFiltrados.map((p) => ({
                  label: p.nombre,
                  value: p.programa_academico_id,
                }))}
                ...
                disabled={
                  !formData.facultad_id || programasFiltrados.length === 0
                }
              />
            </div>
